...
public class MessagesViewModel extends AndroidViewModel {
     ...
     */
    private Map<Integer, MutableLiveData<List<Message>>> mMessages;
     ...
     */
    public List<Message> getMessageListByChatId(final int chatId) {
     ...
     * @param message
     */
    public void addMessage(final int chatId, final Message message) {
        List<Message> list = getMessageListByChatId(chatId);
        list.add(message);
